//
//  CoverflowTableViewController.m
//  TCoverFlowView
//
...
#import "CoverflowTableViewController.h"

#import "Coverflow1ViewController.h"
#import "Coverflow2ViewController.h"

@interface CoverflowTableViewController ()

@end

@implementation CoverflowTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"CoverFlow %ld",(long)indexPath.row];
